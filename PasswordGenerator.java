...
// this class works the backend and will generate the password
public class PasswordGenerator {
    ...
    // The random clas allows us to generate a random number which willbe used to randomly choose the characters
